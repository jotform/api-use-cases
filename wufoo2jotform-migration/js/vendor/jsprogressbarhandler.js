  ...
  */
 	...
 	// Default Options
		var defaultOptions = {
			...
			boxImage	: '/js/vendor/percentImage.png',			// boxImage : image around the progress bar
			barImage	: '/js/vendor/percentImage_back3.png',	// Image to use in the progressbar. Can be an array of images too.
			 ...
			 */
				...
				processQueueEntry	: function(targetPercentage) {
					...
					if (curPercentage != newPercentage) {
						...
						this.timer = setTimeout(function() { this.processQueueEntry(targetPercentage); }.bind(this), 60);
